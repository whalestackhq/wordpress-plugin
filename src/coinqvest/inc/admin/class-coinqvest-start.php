						...
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">
							<div id="dashboard_site_health" class="postbox ">
								...
								<div class="inside">
                                    <ol>
                                        <li>
                                            <a href="https://www.coinqvest.com" target="_blank"><?php echo esc_html(sprintf(__('Log in or sign up on COINQVEST.', 'coinqvest')))?></a>
                                        </li>
                                        <li>
                                            <a href="https://www.coinqvest.com/en/api-settings" target="_blank"><?php echo esc_html(sprintf(__('Get your API Keys.', 'coinqvest')))?></a>
                                        </li>
                                        <li>
					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">
							<div id="dashboard_site_health" class="postbox ">
								...
								<div class="inside">
                                    <ul>
                                        <li>- <?php echo esc_html(__('API documentation', 'coinqvest'))?> -> <a href="https://www.coinqvest.com/en/api-docs#post-checkout-hosted" target="_blank"><?php echo esc_html(__('Hosted Checkouts', 'coinqvest'))?></a></li>
                                        <li>- <a href="https://www.coinqvest.com/en/blog" target="_blank"><?php echo esc_html(__('Blog', 'coinqvest'))?></a></li>
                                        <li>- <a href="https://www.coinqvest.com/en/help-center#overview" target="_blank"><?php echo esc_html(__('Help Center', 'coinqvest'))?></a></li>
                                    </ul>
								</div>
							</div>
						</div>
